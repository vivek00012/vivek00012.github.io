<?php
                ...
                echo "<li>
                    <a href='#'>
                        <span class='photo'><img alt='avatar' src=''><i class='fa fa-user' aria-hidden='true'></i></span>
                                <span class='subject'>";
                            ...
                            }elseif(($hoursdiff2)>=24 && ($daysdiff >0) && ($monthsdiff)==0 &&($yeardiff)==0){
                                echo "<span class='time'>(<span style='color:#fff;font-wight:bold'>" .(($daysdiff2 - 1)). "</span>)<i> days ago</i></span>";  
